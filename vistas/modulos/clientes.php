          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-sm" name="nuevoDocumentoId" placeholder="Ingresar documento" data-inputmask="'mask':'99999999'" data-mask required>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-sm" name="editarCliente" id="editarCliente" required>
